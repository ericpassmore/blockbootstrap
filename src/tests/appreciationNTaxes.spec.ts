...
describe('Taxes', () => {
    ...
    it('check taxes/appreciation for block 9 with 100% Treasuries', () => {
                const allocations: Allocation[] = [
            { key: 'treasury10Year', label: '10-Year Treasury', value: 100 }
        ];
        const startingAmount = 100000;
    ...
    it('check taxes/appreciation for block 9 with 100% baaCorp', () => {
                const allocations: Allocation[] = [
    ...
    it('check taxes/appreciation block 4 with 100% sp500', () => {
                const allocations: Allocation[] = [
            { key: 'sp500', label: 'S&P 500', value: 100 }
        ];
        const startingAmount = 100000;
        const model = new ModelReturns(startingAmount, allocations, 4);
